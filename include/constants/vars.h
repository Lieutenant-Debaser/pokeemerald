...
#define VAR_REPEL_LAST_USED                  0x404E // Var for storing last-used repel for reuse repel prompt
#define VAR_LOTAD_SIZE_RECORD                0x404F
#define VAR_LITTLEROOT_TOWN_STATE            0x4050
#define VAR_OLDALE_TOWN_STATE                0x4051
#define VAR_HM09_READY                       0x4052 // Takes place of VAR_DEX_UPGRADE_JOHTO_STARTER_STATE and instead allows for Birch to give player HM09 instead of Johto starter
