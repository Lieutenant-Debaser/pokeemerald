...
#define FLAG_EVERGRANDE_GUARD_MOVED              0x54  // Should guard in Ever Grande city move
...
#define FLAG_RECEIVED_SHINY_CHARM            0x96 // Indicates if player has received shiny charm after national dex has been completed
...
#define FLAG_UNUSED_0x0DC                    0xDC // Unused Flag; Reclaimed
...
#define FLAG_UNUSED_0x10E                    0x10E  // Unused; Reclaimed
...
#define FLAG_DEFEATED_MEWTWO                 0x1E3 // Flag used to set if Mewtwo has been caught/defeated
...
#define FLAG_HIDE_MEWTWO                                            0x2D9 // Hide Mewtwo in lair
...
#define FLAG_RECEIVED_HM09_FROM_LANETTE             (SYSTEM_FLAGS + 0x83) // Indicates if the player has received HM09 from Lanette
