...
static const u8 sMapName_FerriteCave[]  = _("FERRITE CAVE");
...
static const u8 sMapName_CeruleanCave[] = _("OMINOUS CAVERNS");
...
const struct RegionMapLocation gRegionMapEntries[] = {
    ...
    [MAPSEC_FERRITE_CAVE]               = { 0, 0, 1, 1, sMapName_FerriteCave},
